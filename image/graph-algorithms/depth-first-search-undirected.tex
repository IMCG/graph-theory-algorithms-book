...
\tikzexternalize{depth-first-search-undirected}
...
%% light edges or lines
\path
\foreach \startnode/\endnode in {2/3, 2/5, 2/7, 3/4, 4/6, 6/7}
{
  (\startnode) edge[lightLine] node {} (\endnode)
}
%% dark edges or lines
\foreach \startnode/\endnode in {1/2, 1/5, 3/5, 5/6}
{
  (\startnode) edge[darkLine] node {} (\endnode)
};
\end{tikzpicture}
...
%% light edges or lines
\path
\foreach \startnode/\endnode in {2/3, 2/5, 2/7, 3/4}
{
  (\startnode) edge[lightLine] node {} (\endnode)
}
%% dark edges or lines
\foreach \startnode/\endnode in {1/2, 1/5, 3/5, 4/6, 5/6, 6/7}
{
  (\startnode) edge[darkLine] node {} (\endnode)
};
\end{tikzpicture}
