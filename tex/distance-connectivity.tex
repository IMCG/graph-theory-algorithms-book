...
\centering
\index{eccentricity}
\input{image/distance-connectivity/eccentricity-distribution.tex}
...
vertex cut and $T$ is an edge cut. When it is clear from context, we
simply refer to a separating\index{separating set} set. See
...
\caption{Vertex and edge separating sets. Blue-colored vertices are
  ...
  separating set or vertex cut; the red-colored edges constitute an
  edge separating set or edge cut.}
