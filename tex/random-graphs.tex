...
\caption{Degree distribution of the neural network of the
  ...
  with $297$ vertices and 2,359 edges. The degree distribution is
...
\caption{Degree distribution of the Western States Power Grid of the
  ...
  graph with 4,941 vertices and 6,594 edges. The degree distribution
  is derived from dataset by Watts and
