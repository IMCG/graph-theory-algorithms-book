...
\caption{Briggs' algorithm for random dense graph in $G(n,N)$.}
...
\item In~2006, Keith M. Briggs\index{Briggs, Keith M.}
  ...
  dense graph in $G(n,N)$, inspired by Knuth's Algorithm~S
  (Selection sampling technique) as found on page~142 of
  Knuth~\cite{Knuth1998b}. Pseudocode of Briggs' algorithm is
  presented in Algorithm~\ref{alg:random_graphs:Briggs_random_GnN}.
  %%
  \begin{enumerate}[(a)]
