...
\caption{Generation of random graph in $G(n,N)$ in linear expected time.}
...
$i$ be the number of edges chosen so far, then the probability of
...
$\binom{n}{2} - N$ edges from the latter graph.
