...
Stanley Milgram\index{Milgram, Stanley}. Milgram distributed a number
...
properties of $G(n,p)$\index{random graph!binomial}. Small-world
...
\item In~2006, Keith M. Briggs\index{Briggs!Keith M.}
  ...
  graph in $G(n,N)$, inspired by Knuth's\index{Knuth!Algorithm~S}
...
\item Diego Garlaschelli\index{Garlaschelli, Diego}
  ...
  $G(n,p)$ model, called the weighted\index{random graph!weighted}
