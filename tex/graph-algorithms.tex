...
square of the board. Our objective is to find a sequence of
knight\index{chess!knight piece} moves that visits each and every
square exactly once, while obeying the rules of chess\index{chess}
that govern the movement of the knight
