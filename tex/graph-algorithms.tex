...
\SetKwData{True}{True}
%% input/output
\Input{A connected graph $G = (V, E)$ having non-negative edge weghts
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=9cm,width=6cm]{dijkstras-algorithm-example2}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=7cm,width=13cm]{dijkstras-algorithm-example3}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=9cm,width=7cm]{bellman-ford-algorithm-example1}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=7cm,width=13cm]{bellman-ford-algorithm-example3}
\end{center}
