...
Figure \ref{fig:FRW-algorithm-example2}.



\begin{figure}[h!]
\begin{center}
\includegraphics[height=9cm,width=9cm]{FRW-algorithm-example2}
\end{center}
\caption{Floyd-Roy-Warshall algorithm example . }
\label{fig:FRW-algorithm-example2}
\end{figure}
