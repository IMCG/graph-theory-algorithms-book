...
Wiener~\cite{Wiener1947}. If $G = (V,E)$ is a graph with vertex set
...
\item Let $G$ be a simple undirected graph having distance matrix
  ...
  \item The \emph{total distance} $td(u)$ of a fixed vertex
    ...
    %%
    \begin{equation}
    \label{eqn:graph_algorithms:toal_distance_vertex}
    td(u)
    =
    \sum_k d_{i,k}
    =
  ...
  \item Would
    equations~\eqref{eqn:graph_algorithms:toal_distance_vertex}
