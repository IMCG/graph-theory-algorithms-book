...
\input{image/graph-algorithms_Petersen-graph.tex}
...
published~\cite{Petersen1898} a graph that bears his name: the
...
\index{depth-first search}
\index{Petersen graph}
\input{image/graph-algorithms_search-Petersen-graph.tex}
