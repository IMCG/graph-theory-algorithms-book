...
label $L(v)$. This temprary label can be either $\infty$ if no path
...
\underline{0} & $\infty$      & $\infty$      & $\infty$      & $\infty$ \\
              ...
              &               &               &               & \underline{5} \\\hline
\end{tabular}
\caption{Another walkthrough of Dijkstra's algorithm.}
...
took, i.e. seaching for the ``cheapest'' path, the Bellman-Ford
