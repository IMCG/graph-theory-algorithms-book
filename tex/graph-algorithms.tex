...
{\color{red}
\begin{itemize}
\item Discuss efficient methods to
  compute~\eqref{eq:graph_algorithms:big_endian_binary_to_integer}. This
  might start off discussing Horner's method and followed by bit-level
