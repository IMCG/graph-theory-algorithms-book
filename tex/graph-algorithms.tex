...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_graph-adjacency-lists.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_breadth-first-search-undirected.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_depth-first-search-undirected.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_Dijkstra-algorithm-digraph.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_Floyd-Roy-Warshall-demo.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_another-Floyd-Roy-Warshall-demo.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/graph_algorithms_Dijkstra-directed-house-graph.tex}
