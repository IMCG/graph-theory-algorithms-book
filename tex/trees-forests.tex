...
outlines steps to construct a binary tree representation corresponding
to the Huffman code of an alphabet.
...
%% algorithm body
$n \leftarrow |A|$\;
$Q \leftarrow A$~\tcc*[f]{minimum priority queue}\;
...
\begin{example}
\label{eg:trees_forests:simple_Huffman_code}
{\rm
...
\item Verify that $C = \{1, 00, 01\}$ is another Huffman code for the
  weighted alphabet in
  Example~\ref{eg:trees_forests:simple_Huffman_code}. Draw the tree
  representation of $C$.
