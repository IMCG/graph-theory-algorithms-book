...
in Oxley's survey~\cite{Oxley2003}. Recall that a minimal edge cut of
...
involves securing an edge against destruction. The next result can be
found in Oxley~\cite{Oxley2003}.
