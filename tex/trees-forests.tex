...
\centering
\subfigure[]{
\includegraphics[height=7cm,width=7cm]{boruvkas-algorithm-example1a}
}
\subfigure[]{
\includegraphics[height=7cm,width=2cm]{boruvkas-algorithm-example1b}
}
...
(see Figure \ref{fig:Q3bw} for an example).


\begin{figure}[h!]
\begin{center}
\includegraphics[height=8cm,width=8cm]{Q3bw}
\end{center}
\caption{{\bf Plot of $\Gamma_3$ viewed as a Hamiltonian path on $Q_3$ .} }
\label{fig:Q3bw}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=8cm,width=8cm]{graycode-binary-length8}
\end{center}
\caption{{\bf List plot of $\Gamma_8$ created using \sage .} }
\label{fig:Gamma8}
\end{figure}
...
In general, if $C$ is a code contained in ${\mathbb B}_\ell$
