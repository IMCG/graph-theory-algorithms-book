...
\begin{figure}[!htbp]
\begin{tabular}{cc}
\includegraphics[height=7cm,width=7cm]{prim-algorithm-example1}
&
\includegraphics[height=7cm,width=7cm]{prim-algorithm-example2}
\end{tabular}

\caption{Example of Prim's algorithm. On the left is the original and
  on the right is the MST produced by Prim's algorithm.}
...
%% \begin{center}
%% \begin{tabular}{cc}
%% \includegraphics[height=9cm,width=7cm]{prim-algorithm-example3}
%% &
%% \includegraphics[height=9cm,width=4cm]{prim-algorithm-example4}
%% \end{tabular}
%% \end{center}
%% \caption{Another example of Prim's algorithm. On the left is the original and
%%   on the right is the MST produced by Prim's algorithm.}
