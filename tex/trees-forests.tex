...
\item Consider an undirected, connected simple graph $G = (V,E)$ of
  ...
  Yamada~et~al.~\cite{YamadaEtAl2009} provide an $O(Nm \lg n)$
  algorithm to construct all the $N$ minimum spanning trees of
  $G$. Describe and provide pseudocode of the Yamada-Kataoka-Watanabe
  algorithm. Provide runtime analysis and prove the correctness of
  this algorithm.
...
\item The Lucas\index{Lucas!number} number $L_n$, named after
  \'Eduoard Lucas\index{Lucas!\'Eduoard}, has the following recursive
  definition:
  \[
  L_n
  =
