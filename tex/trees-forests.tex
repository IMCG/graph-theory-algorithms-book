...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_filesystem-hierarchy.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_grid-graph-spanning-trees.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_distinct-trees-specified-order-1-2-3.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_distinct-trees-specified-order-4.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_distinct-trees-specified-order-5.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_distinct-trees-specified-order-6.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/tree-forests_Prim-algorithm-digraph.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/tree-forests_Prim-algorithm-digraph2.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/tree-forests_Boruvkas-algorithm.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_gray-code-cube.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_Gamma-8.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_tree-representation-B-2.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees_forests_binary-tree-Huffman-encodings.tex}
