...
specified \emph{root}\index{root} vertex $v_0$. However, if $G$ is a
...
family tree in Figure~\ref{fig:introduction:family_tree}, and the
expression tree in
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_filesystem-hierarchy.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_classification-tree-organisms.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_expression-tree-perfect-square.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_grid-graph-spanning-trees.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_distinct-trees-specified-order-1-2-3.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_distinct-trees-specified-order-4.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_distinct-trees-specified-order-5.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_distinct-trees-specified-order-6.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_Kruskal-example.tex}
...
\input{algorithm/trees-forests_Prim-algorithm.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_Prim-algorithm-digraph.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_Prim-algorithm-digraph2.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_Boruvkas-algorithm.tex}
...
\begin{table}[!htbp]
\centering
\input{data/trees-forests_Morse-code.tex}
\caption{Morse code}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_gray-code-cube.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_gamma8.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_tree-representation-B-2.tex}
...
\begin{algorithm}[!htpb]
\input{algorithm/trees-forests_binary-tree-Huffman-codes.tex}
...
\begin{algorithm}[!htpb]
\input{algorithm/trees-forests_Huffman-encoding-alphabet.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/trees-forests_binary-tree-Huffman-encodings.tex}
