...
\index{binary tree}
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-2-vertices_a}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-2-vertices_b}
}
...
\index{binary tree}
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-3-vertices_a}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-3-vertices_b}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-3-vertices_c}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-3-vertices_d}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-3-vertices_e}
}
...
\index{binary tree}
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_a}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_b}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_c}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_d}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_e}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_f}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_g}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_h}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_i}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_j}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_k}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_l}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_m}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/binary-trees-4-vertices_n}
}
...
\index{Huffman code!tree representation}
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_a}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_b}
}
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_c}
}
\qquad\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_d}
}
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_e}
}
\quad\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_f}
}
\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_g}
}
\qquad\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_h}
}
\qquad\quad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_i}
}
\qquad\qquad
\subfigure[]{
  \includegraphics{image/trees-forests/construct-Huffman-tree_j}
}
...
\subfigure[]{
  ...
  \includegraphics{image/trees-forests/binary-tree-Huffman-encodings_a}
}
\subfigure[]{
  \label{fig:trees_forests:eg:binary_tree_Huffman_encodings:Huffman_encodings}
  \includegraphics{image/trees-forests/binary-tree-Huffman-encodings_b}
}
