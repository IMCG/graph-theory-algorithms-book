...
\centering
\index{Fibonacci!tree}
\input{image/tree-data-structures/AVL-tree-balanced-after-insertion.tex}
...
Figure~\ref{fig:tree_data_structures:augmented_tree_unbalanced}). We
have determined the location at which the height-balance property is
first violated.

\begin{figure}[!htbp]
\centering
\input{image/tree-data-structures/AVL-unbalanced-after-insertion.tex}
...
\begin{figure}[!htbp]
\centering
\input{image/tree-data-structures/AVL-trinode-restructure.tex}
\caption{Single rotation in the trinode restructure process.}
\label{fig:tree_data_structures:}
\end{figure}
