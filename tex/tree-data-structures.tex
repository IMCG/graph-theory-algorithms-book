...
determine the maximum vertex of $T$ in constant time $O(1)$ as
well. The maximum vertex of $T$ is the vertex whose key is maximum
among all keys of vertices in $T$. The maximum vertex is identified as
the right-most internal vertex of $T$ having the greatest depth.
