...
known as \emph{Fibonacci trees}\index{Fibonacci!tree} because the
construction of Fibonacci trees bears some resemblance to how
Fibonacci numbers\index{Fibonacci!number} are produced. Fibonacci
...
$F_{n-2}$ and $F_{n-1}$, respectively. Refer to
Figure~\ref{fig:tree_data_structures:Fibonacci_trees_1_to_6} for
...
\caption{Fibonacci trees of height $n = 0, 1, 2, 3, 4, 5, 6$.}
\label{fig:tree_data_structures:Fibonacci_trees_1_to_6}
\end{figure}
